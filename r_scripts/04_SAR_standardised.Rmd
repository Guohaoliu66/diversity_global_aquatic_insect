...
data=data.frame(All[,c(1:2,4,6,8,10,12,14:33)])
...
# TDq0 optimal SAR model and Moran's I test
```{r}
...
write.csv(index_TDq0,file = "st_TDq0.csv")
```
...
# TDq1 optimal SAR model and Moran's I test
```{r}
...
write.csv(index_TDq1,file = "st_TDq1.csv")
```
...
hl<-combn(1:20,20)
rl<- colnames(data)[8:27]
xl0<-as.formula(paste("TDq2 ~",paste(rl[hl[,1]],collapse = " + ")))
...
least_aic_TDq2<-
{
  ...
  for(i in 1:20)
  {
    x<-as.formula(paste("TDq2 ~",paste(rl0[hl0[,i]],collapse = " + ")))
    mod.sem <-spatialreg::errorsarlm(x,data=data,                       listw=W_cont_el_mat2,zero.policy=T)
    sem.aic<-AIC(mod.sem);print(sem.aic)
    com<-data.frame(m=1,n=i,aic=sem.aic)
    comb<-rbind(comb,com)
  ...
  for(i in 1:19)
  {
    x<-as.formula(paste("TDq2 ~",paste(rl1[hl1[,i]],collapse = " + ")))
    mod.sem <-spatialreg::errorsarlm(x, data=data,
    listw=W_cont_el_mat2,zero.policy=T)
    sem.aic<-AIC(mod.sem);print(sem.aic)
    com<-data.frame(m=2,n=i,aic=sem.aic)
  ...
  for(i in 1:18)
  {
    x<-as.formula(paste("TDq2 ~",paste(rl2[hl2[,i]],collapse = " + ")))
    mod.sem <-spatialreg::errorsarlm(x, data=data,
    listw=W_cont_el_mat2,zero.policy=T)
    sem.aic<-AIC(mod.sem);print(sem.aic)
    com<-data.frame(m=3,n=i,aic=sem.aic)
  ...
  for(i in 1:17)
  {
    x<-as.formula(paste("TDq2 ~",paste(rl3[hl3[,i]],collapse = " + ")))
    mod.sem <-spatialreg::errorsarlm(x, data=data,
    listw=W_cont_el_mat2,zero.policy=T)
    sem.aic<-AIC(mod.sem);print(sem.aic)
    com<-data.frame(m=4,n=i,aic=sem.aic)
  ...
  for(i in 1:16)
  {
    x<-as.formula(paste("TDq2 ~",paste(rl4[hl4[,i]],collapse = " + ")))
    mod.sem <-spatialreg::errorsarlm(x, data=data,
    listw=W_cont_el_mat2,zero.policy=T)
    sem.aic<-AIC(mod.sem);print(sem.aic)
    com<-data.frame(m=5,n=i,aic=sem.aic)
  ...
  for(i in 1:15)
  {
    x<-as.formula(paste("TDq2 ~",paste(rl5[hl5[,i]],collapse = " + ")))
    mod.sem <-spatialreg::errorsarlm(x, data=data,
    listw=W_cont_el_mat2,zero.policy=T)
    sem.aic<-AIC(mod.sem);print(sem.aic)
    com<-data.frame(m=6,n=i,aic=sem.aic)
  ...
  for(i in 1:14)
  {
    x<-as.formula(paste("TDq2 ~",paste(rl6[hl6[,i]],collapse = " + ")))
    mod.sem <-spatialreg::errorsarlm(x, data=data,
    listw=W_cont_el_mat2,zero.policy=T)
    sem.aic<-AIC(mod.sem);print(sem.aic)
    com<-data.frame(m=7,n=i,aic=sem.aic)
  ...
  for(i in 1:13)
  {
    x<-as.formula(paste("TDq2 ~",paste(rl7[hl7[,i]],collapse = " + ")))
    mod.sem <-spatialreg::errorsarlm(x, data=data,
    listw=W_cont_el_mat2,zero.policy=T)
    sem.aic<-AIC(mod.sem);print(sem.aic)
    com<-data.frame(m=8,n=i,aic=sem.aic)
  ...
  for(i in 1:12)
  {
    x<-as.formula(paste("TDq2 ~",paste(rl8[hl8[,i]],collapse = " + ")))
    mod.sem <-spatialreg::errorsarlm(x, data=data,
    listw=W_cont_el_mat2,zero.policy=T)
    sem.aic<-AIC(mod.sem);print(sem.aic)
    com<-data.frame(m=9,n=i,aic=sem.aic)
  ...
  for(i in 1:11)
  {
    x<-as.formula(paste("TDq2 ~",paste(rl9[hl9[,i]],collapse = " + ")))
    mod.sem <-spatialreg::errorsarlm(x, data=data,
    listw=W_cont_el_mat2,zero.policy=T)
    sem.aic<-AIC(mod.sem);print(sem.aic)
    com<-data.frame(m=10,n=i,aic=sem.aic)
  ...
  for(i in 1:10)
  {
    x<-as.formula(paste("TDq2 ~",paste(rl10[hl10[,i]],collapse = " + ")))
    mod.sem <-spatialreg::errorsarlm(x, data=data,
    listw=W_cont_el_mat2,zero.policy=T)
    sem.aic<-AIC(mod.sem);print(sem.aic)
    com<-data.frame(m=11,n=i,aic=sem.aic)
  ...
  for(i in 1:9)
  {
    x<-as.formula(paste("TDq2 ~",paste(rl11[hl11[,i]],collapse = " + ")))
    mod.sem <-spatialreg::errorsarlm(x, data=data,
    listw=W_cont_el_mat2,zero.policy=T)
    sem.aic<-AIC(mod.sem);print(sem.aic)
    com<-data.frame(m=12,n=i,aic=sem.aic)
  ...
  for(i in 1:8)
  {
    x<-as.formula(paste("TDq2 ~",paste(rl12[hl12[,i]],collapse = " + ")))
    mod.sem <-spatialreg::errorsarlm(x, data=data,
    listw=W_cont_el_mat2,zero.policy=T)
    sem.aic<-AIC(mod.sem);print(sem.aic)
    com<-data.frame(m=13,n=i,aic=sem.aic)
  ...
  for(i in 1:7)
  {
    x<-as.formula(paste("TDq2 ~",paste(rl13[hl13[,i]],collapse = " + ")))
    mod.sem <-spatialreg::errorsarlm(x, data=data,
    listw=W_cont_el_mat2,zero.policy=T)
    sem.aic<-AIC(mod.sem);print(sem.aic)
    com<-data.frame(m=14,n=i,aic=sem.aic)
  ...
  for(i in 1:6)
  {
    x<-as.formula(paste("TDq2 ~",paste(rl14[hl14[,i]],collapse = " + ")))
    mod.sem <-spatialreg::errorsarlm(x, data=data,
    listw=W_cont_el_mat2,zero.policy=T)
    sem.aic<-AIC(mod.sem);print(sem.aic)
    com<-data.frame(m=15,n=i,aic=sem.aic)
  ...
  for(i in 1:5)
  {
    x<-as.formula(paste("TDq2 ~",paste(rl15[hl15[,i]],collapse = " + ")))
    mod.sem <-spatialreg::errorsarlm(x, data=data,
    listw=W_cont_el_mat2,zero.policy=T)
    sem.aic<-AIC(mod.sem);print(sem.aic)
    com<-data.frame(m=16,n=i,aic=sem.aic)
  ...
  for(i in 1:4)
  {
    x<-as.formula(paste("TDq2 ~",paste(rl16[hl16[,i]],collapse = " + ")))
    mod.sem <-spatialreg::errorsarlm(x, data=data,
    listw=W_cont_el_mat2,zero.policy=T)
    sem.aic<-AIC(mod.sem);print(sem.aic)
    com<-data.frame(m=17,n=i,aic=sem.aic)
  ...
  for(i in 1:3)
  {
    x<-as.formula(paste("TDq2 ~",paste(rl17[hl17[,i]],collapse = " + ")))
    mod.sem <-spatialreg::errorsarlm(x, data=data,
    listw=W_cont_el_mat2,zero.policy=T)
    sem.aic<-AIC(mod.sem);print(sem.aic)
    com<-data.frame(m=18,n=i,aic=sem.aic)
  ...
  for(i in 1:2)
  {
    x<-as.formula(paste("TDq2 ~",paste(rl18[hl18[,i]],collapse = " + ")))
    mod.sem <-spatialreg::errorsarlm(x, data=data,
    listw=W_cont_el_mat2,zero.policy=T)
    sem.aic<-AIC(mod.sem);print(sem.aic)
    com<-data.frame(m=19,n=i,aic=sem.aic)
...
m2<-least_aic_TDq2[[2]][least_aic_TDq2[[1]][which(least_aic_TDq2[[1]]$aic==min(least_aic_TDq2[[1]]$aic)),1]+1] 

```

# TDq2 optimal SAR model and Moran's I test
```{r}
  ...
  names(comb_SEM)<-my
  data=data
  x<-as.formula(paste("TDq2 ~",paste(unlist(comb_SEM[[my]]),collapse = " + ")))
  morI<-merge(shp,data,by.x="HYBAS_ID",by.y="HYBAS_ID",all.x=F)
  W_cont_el_mat2=nb2listw(new_queen_nb, style="W",zero.policy=TRUE)
  y<-as.data.frame(morI)
  y<-data.frame(HYBAS_ID=y$HYBAS_ID)###name order of morI
  data<-merge(y,data,by.x="HYBAS_ID",by.y="HYBAS_ID",sort=F)
  ## sem model 
  mod.null<-spatialreg::errorsarlm(TDq2~1, data=data,listw=W_cont_el_mat2,Durbin = F, zero.policy=T) # null model
  null.aic<-AIC(mod.null)
  mod.ini<-spatialreg::errorsarlm(xl0, data=data, listw=W_cont_el_mat2,zero.policy=T) # initial model
  ini.aic<-AIC(mod.ini)
  mod.opt <-spatialreg::errorsarlm(x, data=data, listw=W_cont_el_mat2,zero.policy=T) # optimal model 
 ...
 # r2moranI[i,]<-c(round(opt.r2,3),round(I$estimate[1],4),round(I$p.value,3))
  ...
  print(paste("ini.aic = ",round(ini.aic,4)))
  print(paste("opt.aic = ",round(opt.aic,4)))
  index_TDq2=data.frame(my,null.aic,ini.aic,opt.aic,opt.coef,opt.r2,I$statistic,I$p.value)


write.csv(index_TDq2,file = "st_TDq2.csv")
```
...
# FDq0 optimal SAR model and Moran's I test
```{r}
...
write.csv(index_FDq0,file = "st_FDq0.csv")
```
...
# FDq1 optimal SAR model and Moran's I test
```{r}
...
write.csv(index_FDq1,file = "st_FDq1.csv")
```
...
hl<-combn(1:20,20)
rl<- colnames(data)[8:27]
xl0<-as.formula(paste("FDq2 ~",paste(rl[hl[,1]],collapse = " + ")))
...
least_aic_FDq2<-
{
  ...
  for(i in 1:20)
  {
    x<-as.formula(paste("FDq2 ~",paste(rl0[hl0[,i]],collapse = " + ")))
    mod.sem <-spatialreg::errorsarlm(x,data=data,                       listw=W_cont_el_mat2,zero.policy=T)
    sem.aic<-AIC(mod.sem);print(sem.aic)
    com<-data.frame(m=1,n=i,aic=sem.aic)
    comb<-rbind(comb,com)
  ...
  for(i in 1:19)
  {
    x<-as.formula(paste("FDq2 ~",paste(rl1[hl1[,i]],collapse = " + ")))
    mod.sem <-spatialreg::errorsarlm(x, data=data,
    listw=W_cont_el_mat2,zero.policy=T)
    sem.aic<-AIC(mod.sem);print(sem.aic)
    com<-data.frame(m=2,n=i,aic=sem.aic)
  ...
  for(i in 1:18)
  {
    x<-as.formula(paste("FDq2 ~",paste(rl2[hl2[,i]],collapse = " + ")))
    mod.sem <-spatialreg::errorsarlm(x, data=data,
    listw=W_cont_el_mat2,zero.policy=T)
    sem.aic<-AIC(mod.sem);print(sem.aic)
    com<-data.frame(m=3,n=i,aic=sem.aic)
  ...
  for(i in 1:17)
  {
    x<-as.formula(paste("FDq2 ~",paste(rl3[hl3[,i]],collapse = " + ")))
    mod.sem <-spatialreg::errorsarlm(x, data=data,
    listw=W_cont_el_mat2,zero.policy=T)
    sem.aic<-AIC(mod.sem);print(sem.aic)
    com<-data.frame(m=4,n=i,aic=sem.aic)
  ...
  for(i in 1:16)
  {
    x<-as.formula(paste("FDq2 ~",paste(rl4[hl4[,i]],collapse = " + ")))
    mod.sem <-spatialreg::errorsarlm(x, data=data,
    listw=W_cont_el_mat2,zero.policy=T)
    sem.aic<-AIC(mod.sem);print(sem.aic)
    com<-data.frame(m=5,n=i,aic=sem.aic)
  ...
  for(i in 1:15)
  {
    x<-as.formula(paste("FDq2 ~",paste(rl5[hl5[,i]],collapse = " + ")))
    mod.sem <-spatialreg::errorsarlm(x, data=data,
    listw=W_cont_el_mat2,zero.policy=T)
    sem.aic<-AIC(mod.sem);print(sem.aic)
    com<-data.frame(m=6,n=i,aic=sem.aic)
  ...
  for(i in 1:14)
  {
    x<-as.formula(paste("FDq2 ~",paste(rl6[hl6[,i]],collapse = " + ")))
    mod.sem <-spatialreg::errorsarlm(x, data=data,
    listw=W_cont_el_mat2,zero.policy=T)
    sem.aic<-AIC(mod.sem);print(sem.aic)
    com<-data.frame(m=7,n=i,aic=sem.aic)
  ...
  for(i in 1:13)
  {
    x<-as.formula(paste("FDq2 ~",paste(rl7[hl7[,i]],collapse = " + ")))
    mod.sem <-spatialreg::errorsarlm(x, data=data,
    listw=W_cont_el_mat2,zero.policy=T)
    sem.aic<-AIC(mod.sem);print(sem.aic)
    com<-data.frame(m=8,n=i,aic=sem.aic)
  ...
  for(i in 1:12)
  {
    x<-as.formula(paste("FDq2 ~",paste(rl8[hl8[,i]],collapse = " + ")))
    mod.sem <-spatialreg::errorsarlm(x, data=data,
    listw=W_cont_el_mat2,zero.policy=T)
    sem.aic<-AIC(mod.sem);print(sem.aic)
    com<-data.frame(m=9,n=i,aic=sem.aic)
  ...
  for(i in 1:11)
  {
    x<-as.formula(paste("FDq2 ~",paste(rl9[hl9[,i]],collapse = " + ")))
    mod.sem <-spatialreg::errorsarlm(x, data=data,
    listw=W_cont_el_mat2,zero.policy=T)
    sem.aic<-AIC(mod.sem);print(sem.aic)
    com<-data.frame(m=10,n=i,aic=sem.aic)
  ...
  for(i in 1:10)
  {
    x<-as.formula(paste("FDq2 ~",paste(rl10[hl10[,i]],collapse = " + ")))
    mod.sem <-spatialreg::errorsarlm(x, data=data,
    listw=W_cont_el_mat2,zero.policy=T)
    sem.aic<-AIC(mod.sem);print(sem.aic)
    com<-data.frame(m=11,n=i,aic=sem.aic)
  ...
  for(i in 1:9)
  {
    x<-as.formula(paste("FDq2 ~",paste(rl11[hl11[,i]],collapse = " + ")))
    mod.sem <-spatialreg::errorsarlm(x, data=data,
    listw=W_cont_el_mat2,zero.policy=T)
    sem.aic<-AIC(mod.sem);print(sem.aic)
    com<-data.frame(m=12,n=i,aic=sem.aic)
  ...
  for(i in 1:8)
  {
    x<-as.formula(paste("FDq2 ~",paste(rl12[hl12[,i]],collapse = " + ")))
    mod.sem <-spatialreg::errorsarlm(x, data=data,
    listw=W_cont_el_mat2,zero.policy=T)
    sem.aic<-AIC(mod.sem);print(sem.aic)
    com<-data.frame(m=13,n=i,aic=sem.aic)
  ...
  for(i in 1:7)
  {
    x<-as.formula(paste("FDq2 ~",paste(rl13[hl13[,i]],collapse = " + ")))
    mod.sem <-spatialreg::errorsarlm(x, data=data,
    listw=W_cont_el_mat2,zero.policy=T)
    sem.aic<-AIC(mod.sem);print(sem.aic)
    com<-data.frame(m=14,n=i,aic=sem.aic)
  ...
  for(i in 1:6)
  {
    x<-as.formula(paste("FDq2 ~",paste(rl14[hl14[,i]],collapse = " + ")))
    mod.sem <-spatialreg::errorsarlm(x, data=data,
    listw=W_cont_el_mat2,zero.policy=T)
    sem.aic<-AIC(mod.sem);print(sem.aic)
    com<-data.frame(m=15,n=i,aic=sem.aic)
  ...
  for(i in 1:5)
  {
    x<-as.formula(paste("FDq2 ~",paste(rl15[hl15[,i]],collapse = " + ")))
    mod.sem <-spatialreg::errorsarlm(x, data=data,
    listw=W_cont_el_mat2,zero.policy=T)
    sem.aic<-AIC(mod.sem);print(sem.aic)
    com<-data.frame(m=16,n=i,aic=sem.aic)
  ...
  for(i in 1:4)
  {
    x<-as.formula(paste("FDq2 ~",paste(rl16[hl16[,i]],collapse = " + ")))
    mod.sem <-spatialreg::errorsarlm(x, data=data,
    listw=W_cont_el_mat2,zero.policy=T)
    sem.aic<-AIC(mod.sem);print(sem.aic)
    com<-data.frame(m=17,n=i,aic=sem.aic)
  ...
  for(i in 1:3)
  {
    x<-as.formula(paste("FDq2 ~",paste(rl17[hl17[,i]],collapse = " + ")))
    mod.sem <-spatialreg::errorsarlm(x, data=data,
    listw=W_cont_el_mat2,zero.policy=T)
    sem.aic<-AIC(mod.sem);print(sem.aic)
    com<-data.frame(m=18,n=i,aic=sem.aic)
  ...
  for(i in 1:2)
  {
    x<-as.formula(paste("FDq2 ~",paste(rl18[hl18[,i]],collapse = " + ")))
    mod.sem <-spatialreg::errorsarlm(x, data=data,
    listw=W_cont_el_mat2,zero.policy=T)
    sem.aic<-AIC(mod.sem);print(sem.aic)
    com<-data.frame(m=19,n=i,aic=sem.aic)
...
m2<-least_aic_FDq2[[2]][least_aic_FDq2[[1]][which(least_aic_FDq2[[1]]$aic==min(least_aic_FDq2[[1]]$aic)),1]+1] 

```

# FDq2 optimal SAR model and Moran's I test
```{r}
  ...
  names(comb_SEM)<-my
  data=data
  x<-as.formula(paste("FDq2 ~",paste(unlist(comb_SEM[[my]]),collapse = " + ")))
  morI<-merge(shp,data,by.x="HYBAS_ID",by.y="HYBAS_ID",all.x=F)
  W_cont_el_mat2=nb2listw(new_queen_nb, style="W",zero.policy=TRUE)
  y<-as.data.frame(morI)
  y<-data.frame(HYBAS_ID=y$HYBAS_ID)###name order of morI
  data<-merge(y,data,by.x="HYBAS_ID",by.y="HYBAS_ID",sort=F)
  ## sem model 
  mod.null<-spatialreg::errorsarlm(FDq2~1, data=data,listw=W_cont_el_mat2,Durbin = F, zero.policy=T) # null model
  null.aic<-AIC(mod.null)
  mod.ini<-spatialreg::errorsarlm(xl0, data=data, listw=W_cont_el_mat2,zero.policy=T) # initial model
  ini.aic<-AIC(mod.ini)
  mod.opt <-spatialreg::errorsarlm(x, data=data, listw=W_cont_el_mat2,zero.policy=T) # optimal model 
 ...
 # r2moranI[i,]<-c(round(opt.r2,3),round(I$estimate[1],4),round(I$p.value,3))
  ...
  print(paste("ini.aic = ",round(ini.aic,4)))
  print(paste("opt.aic = ",round(opt.aic,4)))
  index_FDq2=data.frame(my,null.aic,ini.aic,opt.aic,opt.coef,opt.r2,I$statistic,I$p.value)


write.csv(index_FDq2,file = "st_FDq2.csv")
```
