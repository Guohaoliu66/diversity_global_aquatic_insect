...
# TDq2
```{r}
data_TDq2=data.o[which(data.o$bioindex=="TDq2"),]
min=data_TDq2$Estimate-data_TDq2$Std..Error
med=data_TDq2$Estimate
max=data_TDq2$Estimate+data_TDq2$Std..Error

data.p_TDq2=as.data.frame(cbind(min, med, max))
data.p_TDq2$x=data_TDq2$var
data.p_TDq2$x <- factor(data.p_TDq2$x, levels  = rev(unique(data.p_TDq2$x)))

#### stop and check manually

data.p_TDq2$group <- paste0("group", c(rep(1, 4), rep(2, 1),
                                rep(3, 3), rep(4, 3)
                                ))
data.p_TDq2$group_col <- c(rep("darkseagreen", 4), rep("#78bee5", 1),
                    rep("#e7a40e", 3), rep("lightpink", 3))

data.p_TDq2$p<- ifelse(data_TDq2$Pr...z.. < 0.001, "***",
                ifelse(data_TDq2$Pr...z..< 0.01, "**",
                       ifelse(data_TDq2$Pr...z..< 0.05, "*", "")))

data.p_TDq2$p_col[which(data.p_TDq2$p == "*" & data.p_TDq2$med <= 0)] <- "Negtive effect(P<0.05)"
data.p_TDq2$p_col[which(data.p_TDq2$p == "**" & data.p_TDq2$med <= 0)] <- "Negtive effect(P<0.01)"
data.p_TDq2$p_col[which(data.p_TDq2$p == "***" & data.p_TDq2$med <= 0)] <- "Negtive effect(P<0.001)"
data.p_TDq2$p_col[which(data.p_TDq2$p == "" & data.p_TDq2$med <= 0)] <- "Negtive effect(P>=0.05)"
data.p_TDq2$p_col[which(data.p_TDq2$p == "*" & data.p_TDq2$med >= 0)] <- "Postive effect(P<0.05)"
data.p_TDq2$p_col[which(data.p_TDq2$p == "**" & data.p_TDq2$med >= 0)] <- "Postive effect(P<0.01)"
data.p_TDq2$p_col[which(data.p_TDq2$p == "***" & data.p_TDq2$med >= 0)] <- "Postive effect(P<0.001)"
data.p_TDq2$p_col[which(data.p_TDq2$p == "" & data.p_TDq2$med >= 0)] <- "Postive effect(P>=0.05)"

p_TDq2 <- ggplot(data.p_TDq2)+
...
annotate("rect",
           xmin = c(0.5,3.5,6.5,7.5),
           xmax = c(3.5,6.5,7.5,11.5),
           ymin = -4.5, ymax = 4.5, alpha = 0.3, fill = rev(unique(data.p_TDq2$group_col))) +
...
ggsave("plots_TDq2.pdf", height = 5, width = 6.6)
```
...
# FDq2
```{r}
data_FDq2=data.o[which(data.o$bioindex=="FDq2"),]
min=data_FDq2$Estimate-data_FDq2$Std..Error
med=data_FDq2$Estimate
max=data_FDq2$Estimate+data_FDq2$Std..Error

data.p_FDq2=as.data.frame(cbind(min, med, max))
data.p_FDq2$x=data_FDq2$var
data.p_FDq2$x <- factor(data.p_FDq2$x, levels  = rev(unique(data.p_FDq2$x)))

#### stop and check manually

data.p_FDq2$group <- paste0("group", c(rep(1, 1), rep(2, 1),
                                rep(3, 2), rep(4, 1)
                                ))
data.p_FDq2$group_col <- c(rep("darkseagreen", 1), rep("#78bee5", 1),
                    rep("#e7a40e", 2), rep("lightpink", 1))

data.p_FDq2$p<- ifelse(data_FDq2$Pr...z.. < 0.001, "***",
                ifelse(data_FDq2$Pr...z..< 0.01, "**",
                       ifelse(data_FDq2$Pr...z..< 0.05, "*", "")))

data.p_FDq2$p_col[which(data.p_FDq2$p == "*" & data.p_FDq2$med <= 0)] <- "Negtive effect(P<0.05)"
data.p_FDq2$p_col[which(data.p_FDq2$p == "**" & data.p_FDq2$med <= 0)] <- "Negtive effect(P<0.01)"
data.p_FDq2$p_col[which(data.p_FDq2$p == "***" & data.p_FDq2$med <= 0)] <- "Negtive effect(P<0.001)"
data.p_FDq2$p_col[which(data.p_FDq2$p == "" & data.p_FDq2$med <= 0)] <- "Negtive effect(P>=0.05)"
data.p_FDq2$p_col[which(data.p_FDq2$p == "*" & data.p_FDq2$med >= 0)] <- "Postive effect(P<0.05)"
data.p_FDq2$p_col[which(data.p_FDq2$p == "**" & data.p_FDq2$med >= 0)] <- "Postive effect(P<0.01)"
data.p_FDq2$p_col[which(data.p_FDq2$p == "***" & data.p_FDq2$med >= 0)] <- "Postive effect(P<0.001)"
data.p_FDq2$p_col[which(data.p_FDq2$p == "" & data.p_FDq2$med >= 0)] <- "Postive effect(P>=0.05)"

p_FDq2 <- ggplot(data.p_FDq2)+
  ...
  scale_color_manual(name = "",
                     values = c("Negtive effect(P<0.001)"="dodgerblue4",
                                ...
                                "Postive effect(P>=0.05)"="moccasin"))+
annotate("rect",
           xmin = c(0.4,1.5,3.5,4.5),
           xmax = c(1.5,3.5,4.5,5.6),
           ymin = -0.7, ymax = 0.7, alpha = 0.3, fill = rev(unique(data.p_FDq2$group_col))) +
...
ggsave("plots_FDq2.pdf", height = 5, width = 6.6)
```
...
library(ggthemes)
library(ggtext)
SAR_data=read.csv("SAR_ob.csv",header = T)
...
data.p_TDq0$group <- paste0("group", c(rep(1, 4), rep(2, 1),
                                rep(3, 4), rep(4, 4)
                                ))
data.p_TDq0$group_col <- c(rep("darkseagreen", 4), rep("#78bee5", 1),
                    rep("#e7a40e", 4), rep("lightpink", 4))
...
p_TDq0 <- ggplot(data.p_TDq0)+
  ...
  scale_color_manual(name = "",
                     values = c("Negtive effect(P<0.001)"="dodgerblue4",
                                ...
                                "Postive effect(P>=0.05)"="moccasin"))+
annotate("rect",
           xmin = c(0.5,4.5,8.5,9.5),
           xmax = c(4.5,8.5,9.5,13.5),
           ymin = -30, ymax = 30, alpha = 0.3, fill = rev(unique(data.p_TDq0$group_col))) +
...
ggsave("plots_TDq0ob.pdf", height = 5, width = 6.6)
```
...
annotate("rect",
           xmin = c(0.5,3.5,6.5,7.5),
           xmax = c(3.5,6.5,7.5,11.5),
           ymin = -9, ymax = 9, alpha = 0.3, fill = rev(unique(data.p_TDq1$group_col))) +
...
ggsave("plots_TDq1ob.pdf", height = 5, width = 6.6)
```
...
data.p_TDq2$group <- paste0("group", c(rep(1, 3), rep(2, 1),
                                rep(3, 3), rep(4, 3)
                                ))
data.p_TDq2$group_col <- c(rep("darkseagreen", 3), rep("#78bee5", 1),
                    rep("#e7a40e", 3), rep("lightpink", 3))
...
p_TDq2 <- ggplot(data.p_TDq2)+
  ...
  scale_color_manual(name = "",
                     values = c("Negtive effect(P<0.001)"="dodgerblue4",
                                ...
                                "Postive effect(P>=0.05)"="moccasin"))+
annotate("rect",
           xmin = c(0.4,3.5,6.5,7.5),
           xmax = c(3.5,6.5,7.5,10.6),
           ymin = -4.5, ymax = 4.5, alpha = 0.3, fill = rev(unique(data.p_TDq2$group_col))) +
...
ggsave("plots_TDq2ob.pdf", height = 5, width = 6.6)
```
...
data.p_FDq0$group <- paste0("group", c(rep(1, 3), rep(2, 3),
                                rep(3, 2), rep(4, 4)
                                ))
data.p_FDq0$group_col <- c(rep("darkseagreen", 3), rep("#78bee5", 3),
                    rep("#e7a40e", 2), rep("lightpink", 4))
...
p_FDq0 <- ggplot(data.p_FDq0)+
  ...
  scale_color_manual(name = "",
                     values = c("Negtive effect(P<0.001)"="dodgerblue4",
                                ...
                                "Postive effect(P>=0.05)"="moccasin"))+
annotate("rect",
           xmin = c(0.4,4.5,6.5,9.5),
           xmax = c(4.5,6.5,9.5,12.6),
           ymin = -4, ymax = 4, alpha = 0.3, fill = rev(unique(data.p_FDq0$group_col))) +
...
ggsave("plots_FDq0ob.pdf", height = 5, width = 6.6)
```
...
p_FDq1 <- ggplot(data.p_FDq1)+
  ...
  scale_color_manual(name = "",
                     values = c("Negtive effect(P<0.001)"="dodgerblue4",
                                ...
                                "Postive effect(P>=0.05)"="moccasin"))+
annotate("rect",
           xmin = c(0.4,3.5,6.5,8.5),
           xmax = c(3.5,6.5,8.5,10.6),
           ymin = -1.3, ymax = 1.3, alpha = 0.3, fill = rev(unique(data.p_FDq1$group_col))) +
...
ggsave("plots_FDq1ob.pdf", height = 5, width = 6.6)
```
...
data.p_FDq2$group <- paste0("group", c(rep(1, 2), rep(2, 2),
                                rep(3, 2), rep(4, 3)
                                ))
data.p_FDq2$group_col <- c(rep("darkseagreen", 2), rep("#78bee5", 2),
                    rep("#e7a40e", 2), rep("lightpink", 3))
...
ggsave("plots_FDq2ob.pdf", height = 5, width = 6.6)
```
